...
const UserList: React.FC<UserListProps> = (props) => {
    const { userList, size ,Message } = props;
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: size , borderRadius : '10px' ,border:"1px solid black" ,height : '100%' , backgroundColor : '#D3D3D3'}}>
            ...
            {userList.map((user: User) => (
                <div key={user.getId()} style={{ display: 'flex', alignItems: 'center',justifyContent: 'space-around', width: '100%' , cursor : 'pointer' ,marginTop:"10px", backgroundColor : '#FAFAFA' , borderRadius : '10px' }}>
